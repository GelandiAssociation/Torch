...
public class BlockFromToEvent extends BlockEvent implements Cancellable {
    ...
    private static BlockFromToEvent instance;
    
    public static BlockFromToEvent of(final Block block, final BlockFace face) {
        MutableEvent.init(instance);
        
        if (instance == null) {
            instance = new BlockFromToEvent(block, face);
            return instance;
        }
    ...
    public static BlockFromToEvent of(final Block block, final Block toBlock) {
        MutableEvent.init(instance);
        
        if (instance == null) {
            instance = new BlockFromToEvent(block, toBlock);
            return instance;
        }
        
        instance.block = block;
        instance.to = toBlock;
        instance.face = BlockFace.SELF;
